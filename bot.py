...
import hashlib
import uvicorn  # <-- FIX 1: YAHAN IMPORT ADD KIYA HAI
...
**Protected:** Sirf authorized admins hi commands use sakte hain.
    """
...
# === FIX 2: SERVER KO RUN KARNE KE LIYE YE BLOCK ADD KIYA GAYA HAI ===
if __name__ == "__main__":
    ...
    # 'bot:app' ki jagah sirf 'app' likhein kyunki hum اسی file mein hain
