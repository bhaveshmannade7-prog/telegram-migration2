...
ptb = (
    ...
    .updater(None)
    .token(BOT_TOKEN)
    .read_timeout(50)  # <-- FIX: Timeout yahaan badha diya
    .write_timeout(50) # <-- FIX: Timeout yahaan badha diya
    .build()
)
...
async def lifespan(_: FastAPI):
    ...
    # === FIX: Yahaan se galat code hata diya ===
...
# FastAPI app
app = FastAPI(lifespan=lifespan) # Typo pehle hi fix ho gaya tha
