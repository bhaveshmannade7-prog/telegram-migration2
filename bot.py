...
async def setup_database():
    ...
    try:
        # --- SUDHAAR (FIX): 10 second ka timeout lagaya ---
        # Agar 10 sec me connect nahi hua, toh yeh error dega, hang nahi hoga
        ...
        print("❌ DATABASE CONNECTION FAILED: 10 second mein connection time out ho gaya.")
