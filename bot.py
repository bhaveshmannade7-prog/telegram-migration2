...
class MovieDatabase:
    ...
    def save_database(self):
        try:
            # Stats ko update karo save karne se pehle
...
async def lifespan(_: FastAPI):
    ...
    # Application start par lock ko reset karo
    ...
    async with ptb:
        await ptb.start()
        print("Bot application started successfully!") # Confirmation
        yield
...
# FastAPI app
# === BUG FIX: 'lifepspan' ko 'lifespan' kar diya hai ===
