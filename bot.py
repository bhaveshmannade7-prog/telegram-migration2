...
# === FIX 1: VALUEERROR FIX ===
# Agar ADMIN_IDS set nahi hai to crash nahi hoga
...
def clean_caption(caption, preserve_watermark=True):
    ...
    caption = re.sub(r'www\.(?:[a-zA-Z]|[0-9]|[$-_@.&+]|[!*\\(\\),])+', '', caption) # Escaped dot
    
    # Remove @usernames
    caption = re.sub(r'@\w+', '', caption) # Added backslash
    
    # Remove telegram links
    caption = re.sub(r't\.me/\S+', '', caption) # Escaped dot, capitalized S
